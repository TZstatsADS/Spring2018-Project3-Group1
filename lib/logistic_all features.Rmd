...
gist <- read.csv('C:/Users/ding/Documents/GitHub/Spring2018-Project3-Group1/lib/gist/gist10.csv')
...
LBP <- read.csv('C:/Users/ding/Documents/GitHub/Spring2018-Project3-Group1/lib/lbp/lbp.csv',
                header = FALSE)
label <- read.csv('C:/Users/ding/Desktop/train/train/label_train.csv')[,3]
label <- as.data.frame(label)
...
SIFT <- read.csv('C:/Users/ding/Desktop/train/train/SIFT_train.csv',
              header = FALSE)[,-1]
label=read.csv('C:/Users/ding/Desktop/train/train/label_train.csv')[,3]
...
load("C:/Users/ding/Documents/GitHub/Spring2018-Project3-Group1/output/HOG.RData")
HOG <- dat
label <- read.csv('C:/Users/ding/Desktop/train/train/label_train.csv')[,3]
label <- as.data.frame(label)
